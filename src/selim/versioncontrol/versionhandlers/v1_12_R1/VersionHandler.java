package selim.versioncontrol.versionhandlers.v1_12_R1;
...
//		f,k,p,r,s,
	...
	@SuppressWarnings("deprecation")
	private Material getBukkitMaterial(net.minecraft.server.v1_12_R1.Block block) {
		return Material.getMaterial(net.minecraft.server.v1_12_R1.Block.getId(block));
	}

	@SuppressWarnings("deprecation")
	private net.minecraft.server.v1_12_R1.Block getVanillaBlock(Material mat) {
		return net.minecraft.server.v1_12_R1.Block.getById(mat.getId());
	}
	...
	private World getBukkitWorld(net.minecraft.server.v1_12_R1.World world) {
		return (World) world.getWorld();
	}

	private net.minecraft.server.v1_12_R1.World getVanillaWorld(World world) {
	...
	@SuppressWarnings("deprecation")
	private net.minecraft.server.v1_12_R1.IBlockData getVanillaBlockState(Block block) {
	...
	private ItemStack getBukkitItemStack(net.minecraft.server.v1_12_R1.ItemStack stack) {
		return CraftItemStack.asBukkitCopy(stack);
	}

	private net.minecraft.server.v1_12_R1.ItemStack getVanillaItemStack(ItemStack stack) {
